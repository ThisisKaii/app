<div>
    @foreach($tasks->where('status', $status) as $task)
        <div class="task-card" draggable="true" data-task-id="{{ $task->id }}" wire:key="task-{{ $task->id }}"
            ...
            <div
                ...
                <form wire:submit.prevent="save">
                    <div style="padding: 1.5rem;">
                        ...
                        <div style="margin-bottom: 1rem;">
                            <label
                                style="display: block; color: #c9d1d9; margin-bottom: 0.5rem; font-weight: 500;">URL</label>
                        ...
                        <div style="margin-bottom: 1rem;">
                            ...
                            <textarea wire:model="description" rows="4" placeholder="Add task details..."
    ...
    @endif
    @if($confirmDelete)
        <div wire:ignore.self style="position: fixed;
            ...
            <div style="background: #161b22;
                ...
                <div style="display:flex; justify-content: center; gap: 1rem;">
                    <button wire:click="delete" style="background: #ef4444; color: white;
                           padding: 0.5rem 1rem;
                    ...
                    <button wire:click="cancelDelete" style="background: #21262d; color: #c9d1d9;
                           padding: 0.5rem 1rem;
                           border: none; border-radius: 6px;
                           cursor: pointer; font-weight: 500;">
                        Cancel
