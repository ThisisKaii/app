<nav x-data="{ open: false }" style="background-color: #0d1117; border-bottom: 1px solid #21262d;">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1" style="border-top: 1px solid #21262d;">
            <div class="px-4">
                <div class="font-medium text-base" style="color: #c9d1d9;">{{ Auth::user()->name }}</div>
                <div class="font-medium text-sm" style="color: #8b949e;">{{ Auth::user()->email }}</div>
            </div>
